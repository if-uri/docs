...
- `signal-kvm-llm-proxy-refactor-2026-07-09.md` - Signal composer focus (IFURI-237),
  LLM proxy (`llm-urirun-com`), API adapters, test results and refactor plan
...
- `CHANGELOG.md` - documentation repository changes
