...
ORDER=["index","getting-started","naming","commands","registry-and-bindings","transports","logo","roadmap"]
def md(text):
...
<nav><a href="https://ifuri.com/">ifuri.com</a><a href="https://examples.ifuri.com/">Examples</a><a href="https://github.com/if-uri/docs">GitHub</a></nav></header>
