...
ORDER=["index","getting-started","naming","commands","registry-and-bindings","connectors","connector-authoring","generating-connectors","adopt-as-uri","transports","mcp","errors","host-node-lan","novnc-demo","project-structure-audit-2026-06-20","logo","roadmap","repo-standards","release-checklist"]
def md(text):
