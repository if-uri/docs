...
ORDER=["index","getting-started","naming","commands","registry-and-bindings","connectors","connector-authoring","transports","mcp","errors","host-node-lan","novnc-demo","project-structure-audit-2026-06-20","logo","roadmap","release-checklist"]
def md(text):
